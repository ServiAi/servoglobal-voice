...
export default defineConfig({
  ...
  projects: [
    { name: 'auth', testMatch: /auth\.setup\.ts/, use: { viewport: { width: 1440, height: 1024 } } },
    {
      ...
      testMatch: /[\\/](crm-visual|crm-integrations|crm-notifications|crm-voice-capacity|crm-voice-call-contract|ultravox-admin|voice-experiences|tenant-shell)\.spec\.ts$/,
