...
const ACTIVITY_ICONS: Record<string, React.ComponentType<{ className?: string }>> = {
  ...
  call_ended: Phone,
  call_billed: Phone,
  voice_call_requested: Phone,
  voice_call_queued: Phone,
  voice_call_ringing: Phone,
  voice_call_started: Phone,
  voice_call_completed: Phone,
  voice_call_failed: Phone,
  voice_call_cancelled: Phone,
  voice_call_no_answer: Phone,
  voice_call_busy: Phone,
...
const ACTIVITY_COLORS: Record<string, string> = {
  ...
  voice_call_requested: 'bg-sky-500/10 text-sky-500 border-sky-500/20',
  voice_call_queued: 'bg-amber-500/10 text-amber-500 border-amber-500/20',
  voice_call_ringing: 'bg-indigo-500/10 text-indigo-500 border-indigo-500/20',
  voice_call_started: 'bg-blue-500/10 text-blue-500 border-blue-500/20',
  voice_call_completed: 'bg-emerald-500/10 text-emerald-500 border-emerald-500/20',
  voice_call_failed: 'bg-red-500/10 text-red-500 border-red-500/20',
  voice_call_cancelled: 'bg-zinc-500/10 text-zinc-400 border-zinc-500/20',
  voice_call_no_answer: 'bg-zinc-500/15 text-zinc-500 border-zinc-500/10',
  voice_call_busy: 'bg-yellow-500/10 text-yellow-500 border-yellow-500/20',
