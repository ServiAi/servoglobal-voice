    ...
    <div className="grid gap-4 sm:grid-cols-3">
      <div className="sm:col-span-3">
        ...
        <select
          ...
          disabled={disabled}
          className="w-full rounded-lg border border-zinc-700 bg-zinc-950 px-3 py-2.5 text-sm text-zinc-200 focus:border-cyan-500 focus:outline-none focus:ring-1 focus:ring-cyan-500 disabled:opacity-60"
        >
      ...
      <div>
        ...
        <input
          ...
          className="w-full rounded-lg border border-zinc-700 bg-zinc-950 px-3 py-2.5 text-sm text-zinc-200 focus:border-cyan-500 focus:outline-none focus:ring-1 focus:ring-cyan-500 disabled:cursor-not-allowed disabled:opacity-60"
        />
      </div>
      ...
      <div className="rounded-lg border border-zinc-800 bg-zinc-950 px-3 py-2.5">
        <p className="text-xs text-zinc-500">Politica</p>
