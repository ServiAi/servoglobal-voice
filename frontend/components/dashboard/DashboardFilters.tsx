      ...
      <form onSubmit={handleApply} className="flex flex-wrap items-end gap-4">
        ...
        <div className="flex flex-col gap-1.5 flex-1 min-w-[150px]">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-md border border-input bg-background py-2 pl-10 pr-3 text-sm text-foreground focus:border-cyan-500 focus:outline-none focus:ring-1 focus:ring-cyan-500"
            />
          </div>
        </div>
        ...
        <div className="flex flex-col gap-1.5 flex-1 min-w-[150px]">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-md border border-input bg-background py-2 pl-10 pr-3 text-sm text-foreground placeholder:text-muted-foreground focus:border-cyan-500 focus:outline-none focus:ring-1 focus:ring-cyan-500"
            />
          </div>
        </div>
        ...
        <div className="flex flex-col gap-1.5 flex-1 min-w-[150px]">
          ...
          <select
            ...
            className="w-full appearance-none rounded-md border border-input bg-background py-2 pl-3 pr-8 text-sm text-foreground focus:border-cyan-500 focus:outline-none focus:ring-1 focus:ring-cyan-500"
          >
