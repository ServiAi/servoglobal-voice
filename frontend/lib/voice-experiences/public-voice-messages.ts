...
import type { PublicVoiceMessages } from '@/components/public/voice/PublicVoiceExperience';

export async function buildPublicVoiceMessages(): Promise<PublicVoiceMessages> {
  const t = await getTranslations('publicVoiceExperience');
  return {
    eyebrow: t('eyebrow'),
    version: t('version'),
    required: t('required'),
