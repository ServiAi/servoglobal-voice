...
class TenantNotificationRule(Base, TimestampMixin):
    ...
    conditions_mode: Mapped[str] = mapped_column(String(8), nullable=False, default="all")
    variable_mapping_json: Mapped[dict] = mapped_column(sa.JSON, nullable=False, default=dict)
    event_schema_version: Mapped[int] = mapped_column(sa.Integer, nullable=False, default=1)
