...
Las migraciones cubren identidad, analítica, riesgo Auth0, planes/uso, CRM base y contexto de llamadas, Resend/email/formularios, Cal.com/Google Calendar, WhatsApp, voz, disponibilidad de integraciones y notificaciones. La migración más reciente es `202607270001_add_notification_worker_state.py` y la cadena debe conservar una única head.
